...
contract infinityTokensPublic is ERC721, Ownable, HasSecondarySaleFees {
	...
	updateURI(string(abi.encodePacked("https://robertalicerinkeby.azurewebsites.net/api/HttpTrigger?artContract=",addressToString(address(this)),"&id=")));
    NFTIndex = 1;
    fileIPFSReferenceURL = "https://ipfs.infura.io/ipfs/";
    fileArweaveReferenceURL = "https://arweave.net/";
    updateMultiURI("https://robertalicerinkebymulti.azurewebsites.net/api/HttpTrigger?artContract=", "&id=", "&artworkIndex=");
	}  
